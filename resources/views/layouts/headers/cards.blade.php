                ...
                <div class="col-sm-12 col-md-6">
                    <!-- <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">department serving: <span class="text-primary"><strong>{{auth()->user()->department}} </strong><span><a class="btn btn-sm btn-default text-uppercase" href="{{secure_url('profile.edit')}}">change</a></h5>
